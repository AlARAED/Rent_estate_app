...
class Reservations extends Component
{
    ...
    public $search, $notes,$name,$date_start, $number, $deleteId, $reservation_id ,$image ,$imageTemp ,$create_reservation ,$status ,$Status;
    ...
    public function render()
    {
        ...
        if ($this->date_start) {
            $reservations = $reservations->where('date_start',  $this->date_start );
        }
        ...
        if ($this->name) {
            $reservations = $reservations->whereHas("user", function ($q) {
