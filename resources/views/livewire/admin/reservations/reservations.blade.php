                ...
                <div class="col-md-9">
                    <form class="row g-1 justify-content-end" wire:submit.prevent="search">
                        ...
                        <div class="col-md-3 col-sm-7">
                            <label class="text-primary mb-1" for="PatientName">اسم المستخدم</label>
                         ...
                         <div class="col-md-3 col-sm-7">
                            <label class="text-primary mb-1" for="PatientName">ملاحظات</label>
                        ...
                        <div class="col-md-3 col-sm-7">
                            <label class="text-primary mb-1" for="PatientName">التاريخ</label>
                    ...
                    <table class="table table-borderless mb-md-5">
                        ...
                        @foreach($reservations as $key => $reservation)
                            <tr>
                                ...
                                <td class="text-center p-1">
                                    <div class="table-os">{{$reservation->user ? $reservation->user->name : 'لا يوجد'}}</div>
                                </td>
                                <td class="text-center p-1">
                                    <div class="table-os">{{$reservation->product ? $reservation->product->name : ''}}</div>
                                </td>
                                <td class="text-center p-1">
                                    <div class="table-os">{{$reservation->product ? $reservation->product->name : ''}}</div>
                                </td>
                                <td class="text-center p-1">
                                    <div class="table-os">{{$reservation->date}}</div>
                                </td>
                                <td class="text-center p-1">
                                    <div class="table-os">{{$reservation->date}}</div>
                                </td>
                                <td class="text-center p-1">
                                    <div class="table-os">{{$reservation->status}}</div>
                                </td>
                                <td class="text-center p-1">
                                    <div class="table-os">
