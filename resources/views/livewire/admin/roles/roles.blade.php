                    ...
                    <table class="table table-borderless mb-md-5">
                        ...
                        @foreach($roles as $key => $role)
                            <tr>
                                ...
                                <td class="text-center p-1">
                                    <div class="table-os"><span
                                            class="badge badge-success text-dark">{!!  $role->name == "Admin" ? __("All permissions") : $role->permissions()->pluck('name')->implode('</span> <span class="badge badge-success text-dark"> ') !!}</span>
                                    </div>
                                </td>
