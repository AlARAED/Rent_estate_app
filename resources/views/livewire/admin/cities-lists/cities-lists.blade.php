                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if(auth()->user()->can('cities edit'))
                                                        ...
                                                        <a class="btn btn-xs btn-success  {{$city->status == 1 ? 'disabled' : ''}}"
                                                           href="#"
                                                           wire:click.prevent="Status({{$city->id}})"
                                                           data-bs-toggle="modal" data-bs-target="#activeModal"
                                                           title="{{__("Active")}}"><i class="fa fa-check"></i>
                                                        </a>

                                                        <a class="btn btn-xs btn-danger {{$city->status == 0 ? 'disabled' : ''}}"
                                                           href="#"
                                                           wire:click.prevent="Status({{$city->id}})"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content text-center">
                    ...
                    <div class="modal-body">
                        ...
                        @if($create_city)
                            @livewire('admin.cities-lists.cities-lists-create')
    ...
    @if(auth()->user()->can('cities edit'))
        ...
        <div wire:ignore.self class="modal fade " id="EditCity" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content text-center">
                    <div class="modal-header text-center">
                        <h5 class="modal-title text-center" id="exampleModalLongTitle">{{ __('Edit City') }}</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true close-btn"></span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        @if($city_id)
                            @livewire('admin.cities-lists.cities-lists-edit',[$city_id])
                        @endif
                    </div>
                </div>
            </div>
