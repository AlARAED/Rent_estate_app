                                    ...
                                    <div class="table-os">
                                        ...
                                        @if(auth()->user()->can('services categories delete') )
                                            <a class="btn btn-sm mx-1 btn-danger" href="#"
                                               wire:click.prevent="deleteId({{$service_category->id}})"
        ...
        <div class="modal fade" wire:ignore.self id="CreateServiceCategory" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content px-3 bg-light rounded-4">
                    ...
                    @if($create_service_category)
                        @livewire('admin.services.services-categories-create',[$service_category_id])
                    @endif
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content px-3 bg-light rounded-4">
                    ...
                    @if($service_category_id)
                        @livewire('admin.services.services-categories-edit',[$service_category_id])
                    @endif
